...
["#Air",[
 ["#Rotary",[ 
  ["#Transport",[ 
   ["RHS_MELB_MH6M","",{
    ["fillJAC",_this,true] call 5r_ItemCfg_fnc_initInventory; 
   },[],1], 
...
5r_SSS_GroundWoodlandArray = 
["#Ground - Woodland",[
 ["#Protected Patrol Vehicles (PPV) (SECT)",[ 
  ["UK3CB_BAF_Husky_Passenger_GPMG_Green","",{  
   ["fillSection",_this,true] call 5r_ItemCfg_fnc_initInventory; 
   [{_this getVariable "5r_fillInventoryComplete" == true}, {
    _this addMagazineCargoGlobal ["UK3CB_BAF_762_200Rnd",3]; 
   },_this,10,{diag_log format ["[5r_SSS] Failed to add additional items to %1",_this];}] call CBA_fnc_waitUntilAndExecute; 
   _this setFuel 0.33; 
  },[],16], 
  ...
  ["UK3CB_BAF_Panther_GPMG_Green_A","",{ 
   ["fillPlt",_this,true] call 5r_ItemCfg_fnc_initInventory; 
   [{_this getVariable "5r_fillInventoryComplete" == true}, {
    _this addMagazineCargoGlobal ["UK3CB_BAF_762_200Rnd",3]; 
   },_this,10,{diag_log format ["[5r_SSS] Failed to add additional items to %1",_this];}] call CBA_fnc_waitUntilAndExecute; 
   _this setFuel 0.33; 
 ...
 ["#Combat Vehicles (CV) (KRH)",[ 
  ["#Challenger 2",[
      ...
      ["fillAFV",_this,true] call 5r_ItemCfg_fnc_initInventory;
      [{_this getVariable "5r_fillInventoryComplete" == true}, {
 ...
 ["#Manoeuvre Support Vehicles (MSV) (FSG)",[ 
  ["UK3CB_BAF_LandRover_WMIK_HMG_FFR_Green_A","",{ 
   ["fillTeam",_this,true] call 5r_ItemCfg_fnc_initInventory; 
   [{_this getVariable "5r_fillInventoryComplete" == true}, {
    _this addMagazineCargoGlobal ["UK3CB_BAF_762_200Rnd",3]; 
 ...
 ["#Logistic Support Vehicles (LSV) (LSS)",[ 
  ["UK3CB_BAF_LandRover_WMIK_HMG_FFR_Green_B","",{ 
   ...
   [_this] remoteExec ["5r_Common_fnc_attachRespawnActions", 0, true];
   _this setFuel 0.33; 
  },[],12], 
...
/*
 Supply boxes also needs to be listed in initPlayerLocal.sqf function "5r_createLoadingActions"'s "_crates" array to be ViV loadable.
*/
5r_SSS_SuppliesArray = 
["#Supplies",[
 ["#Infantry Resupply",[ 
  ["B_CargoNet_01_ammo_F",["Infantry Resupply Crate","@resupply",""],{ 
  ["resupplycrate",_this,true] call 5r_ItemCfg_fnc_initInventory; 
   [_this, 6] call ace_cargo_fnc_setSize;  
  },[],4], 
  ["B_Slingload_01_Cargo_F",["Large Infantry Resupply Container","@resupply",""],{
   ["resupplycrate",_this,true] call 5r_ItemCfg_fnc_initInventory;
   ["resupplycrate",_this,false] call 5r_ItemCfg_fnc_initInventory;
   ["resupplycrate",_this,false] call 5r_ItemCfg_fnc_initInventory;
  ...
  ["UK3CB_BAF_Box_40_Ammo",["40mm Grenades Box","@resupply",""],{ 
   ["resupply40mm",_this,true] call 5r_ItemCfg_fnc_initInventory; 
  },[],2], 
  ...
  ["ACE_medicalSupplyCrate_advanced","",{ 
   ["resupplymedic",_this,true] call 5r_ItemCfg_fnc_initInventory; 
  },[],2], 
  ["Box_NATO_AmmoOrd_F",["Explosives Crate","",""],{ 
   ["resupplydemo",_this,true] call 5r_ItemCfg_fnc_initInventory;  
  ...
  ["Box_NATO_Equip_F","Night Box",{
   ["resupplyNight",_this,true] call 5r_ItemCfg_fnc_initInventory;  
  },[],3],
  ["CargoNet_01_box_F","Field Arsenal (LSS USE ONLY, not loadable)",{
   ...
   clearBackpackCargoGlobal _this;
   [_this, -1] call ace_cargo_fnc_setSize;  
   [_this, 5r_allArsenalItems, true] call ace_arsenal_fnc_initBox;
